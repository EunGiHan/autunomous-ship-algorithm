...
class UI_Simulator(object):
    def set_UI(self, A_star_Simulator):
        ...
        self.start_heading_x_spinBox.setMinimum(-1)        ###Max도 정하기!!!!!!!!!!!
        ...
        self.start_heading_y_spinBox.setMinimum(-1)        ###Max도 정하기!!!!!!!!!!!
        ...
        self.g_value_rotate_gain_180_doubleSpinBox.setMaximum(1000)
        ...
        # self.h_value_gain_doubleSpinBox.setMaximum(1000)
